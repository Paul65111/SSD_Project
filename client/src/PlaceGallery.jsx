        ...
        <div className="p-8 grid gap-4">
          ...
          {place?.photos?.length > 0 &&
            place.photos.map((photo) => (
              <div>
                <img src={"https://us-central1-reservify-f1cff.cloudfunctions.net/api/uploads/" + photo} alt="" />
              </div>
            ))}
        </div>
      </div>
          ...
          {place.photos?.[0] && (
            <div>
              <img
                ...
                src={"https://us-central1-reservify-f1cff.cloudfunctions.net/api/uploads/" + place.photos[0]}
                alt=""
              />
            </div>
          )}
        ...
        <div className="grid">
          {place.photos?.[1] && (
            <img
              onClick={() => setShowAllPhotos(true)}
              className="aspect-square object-cover cursor-pointer min-w-full"
              src={"https://us-central1-reservify-f1cff.cloudfunctions.net/api/uploads/" + place.photos[1]}
              alt=""
            />
          )}
          <div className="overflow-hidden">
            {place.photos?.[2] && (
              <img
                ...
                src={"https://us-central1-reservify-f1cff.cloudfunctions.net/api/uploads/" + place.photos[2]}
                alt=""
              />
            )}
          </div>
